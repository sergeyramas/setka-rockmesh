        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <span className="font-semibold text-white">{product.carriers.join(', ')}</span>
            </div>
            <div className="flex items-center gap-3 bg-[#1A1A1A] rounded-[12px] p-4">
              <span className="text-[#FF6B00] text-2xl">📦</span>
              <div>
                <p className="text-white font-semibold text-sm">{copy.delivery.warehouseLabel}</p>
          ...
          {/* SVG schematic map */}
          <div ref={mapRef} className="bg-[#1A1A1A] rounded-[24px] p-8">
            <Image
